...
export default function ExplorerSection() {
  ...
  for(let i = 0; i < 3; i ++)
    {
      content.push(
        <div className="relative w-[300px] cursor-pointer gradient-border-hover ">
        <div className="relative h-[234px] bg-[#FFFFFF1A] rounded-[12px] ml-0.5 overflow-hidden p-[10px_12px]">
          <div className="relative top-[50%] ">
            <div className="flex flex-row justify-between">
              <p className="text-white text-[18px] font-[600] leading-[30px] tracking-[0.9px]">ABCD</p>
              <p className="text-white text-[18px] font-[600] leading-[30px] tracking-[0.9px]">ABCD</p>
            </div>
  ...
  return (
    <div className="w-full relative rounded-[12px] bg-[#FFFFFF19]">
      <div className="absolute top-[24px] left-[24px]">
        <p className="text-white text-[24px] font-[600] leading-[30px] tracking-[1.2px]">Explorer</p>
      </div>
      <div className="absolute top-[24px] right-[24px]">
        <p className="text-white text-[18px] font-[400] leading-[30px] tracking-[0.9px] underline">See All</p>
      </div>
